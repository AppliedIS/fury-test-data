...
docker exec -u postgres dockercomposefeatures_postgis_1 dos2unix /tmp/postgis/initial-data.sh 
...
docker exec dockercomposefeatures_geoserver_1 dos2unix /tmp/geoserver/initial-data.sh 
