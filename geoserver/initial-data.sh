...
curl -v -u admin:geoserver -XPOST -T ${DIR}/viirs.xml -H "Content-type: text/xml" http://localhost:8080/geoserver/rest/workspaces/test/datastores/test/featuretypes
